...
import static com.example.pasgenap10rpl222.LoginActivity.fromHtml;
        ...
        BtnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!password.equals(conPassword)){
                    ...
                    Toast.makeText(RegisterActivity.this, "Username atau Password tidak bisa dikosongkan", Toast.LENGTH_SHORT).show();
                }else {
